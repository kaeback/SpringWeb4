...
import com.spring.web4.dao.BoardMapper;
...
public class BoardController {
	...
	/**
	 * 글 삭제 2 - 글 번호와 비밀번호를 각각 전달받아 Map에 담아 처리
	 */
	...
	/**
	 * 글 삭제 3 - 글 번호와 비밀번호를 각각 전달받아 여려개의 parameter로 처리
	 */
